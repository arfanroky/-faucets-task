        ...
        <nav className="flex justify-between px-8 items-center h-14 my-2 relative">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="btn py-2 px-6 border-2 border-blue-500 text-blue-500 font-bold"
            >
              <ArchiveIcon className="w-4 h-4 text-blue-500 inline-block" />{' '}
              <span className="md:inline hidden">Connect Wallet</span>
            </button>
            {wallet && (
              <div className="absolute top-32 left-0 right-0 bottom-0 w-full h-full ">
                <div className="w-[500px] mx-auto flex justify-center items-center h-[350px] gap-6 relative shadow-2xl z-40 bg-white">
                  <h2 className="absolute top-0 left-0 text-2xl font-bold p-2 mb-4">
                    Connect Your Wallet
                  </h2>
                  <p
            ...
            <button
              ...
              className="outline-none border-0 flex gap-1 items-center"
            >
              {user && (
                <span className="inline-block font-bold text-gray-500">
                  {name}
                </span>
              )}
              <UserCircleIcon
         ...
         text-blue-500 border border-blue-500 rounded-full"
            ...
            {userProfile && (
              <ul
                className={`absolute top-14 right-6 border w-[100px] text-center bg-blue-600 `}
              >
